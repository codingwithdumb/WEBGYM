      ...
      <div className="img-part">
        <div className="main-imgg">
          ...
          <div className="text-up mt-5 px-5">
            <h2>FIT&SEXY</h2>
            <p>
              No Pain No Gain !! <br /> Sweat is Sweet !!
            </p>
        ...
        <div className="weloce-to-div mt-5">
          ...
          <p>
            "Welcome to fit and sexy" <br />
            can be interpreted as an invitation or a greeting related to
            achieving fitness and
            <br /> a desirable physical appearance. It suggests a focus on
            improving one's health, fitness level, and overall attractiveness.
          </p>
        </div>
        <hr />
